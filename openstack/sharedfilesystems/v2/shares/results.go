...
// Share213 contains all information associated with an OpenStack Share
// based on microversion 2.13.
type Share213 struct {
	// The shared file system protocol.
	// Added in microversion 2.13.
	ShareProto string `json:"share_proto"`
...
func (r *Share213) UnmarshalJSON(b []byte) error {
	type tmp Share213
	var s struct {
		tmp
		CreatedAt gophercloud.JSONRFC3339MilliNoZ `json:"created_at"`
...
func (r commonResult) ExtractInto(v interface{}) error {
	return r.Result.ExtractIntoStructPtr(v, "share")
}
